...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jslib/jquery-easyui-1.3.1/themes/default/easyui.css" type="text/css">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/style/myCss.css" type="text/css">
